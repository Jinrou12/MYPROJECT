...
const DEFAULT_APPS = [
  ...
  {
    id: "app-3",
    title: "Nexus Code Cloud Sandbox",
    category: "Tool",
    description: "កម្មវិធីសរសេរកូដលើ Web Browser (Online IDE) គាំទ្រ HTML, CSS, JavaScript ជាមួយ Live Preview & Code Syntax Highlighting.",
    descriptionEn: "In-browser web development playground supporting HTML5, CSS3, JS ES6, with live DOM hot-reload and instant sharing.",
    url: "https://example.com/code-sandbox",
    imageUrl: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?q=80&w=800&auto=format&fit=crop",
    tags: ["JavaScript", "Monaco Editor", "HTML5", "CSS3"],
    githubUrl: "https://github.com/visal/code-cloud",
    views: 4100,
    likes: 295,
    featured: true,
  ...
  {
    id: "app-5",
    title: "Futuristic Synth-Wave 3D Game",
    category: "APP",
    description: "ល្បែងកម្សាន្ត 3D Cyber Racer រត់លើ Web Browser ដោយប្រើប្រាស់ Three.js និង WebGL មានសំឡេង Synthwave ពីរោះៗ.",
    descriptionEn: "Hyper-speed 3D web racer game built with Three.js and WebGL featuring dynamic neon synthwave soundscapes.",
    url: "https://example.com/synth-race",
    imageUrl: "https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=800&auto=format&fit=crop",
    tags: ["Three.js", "WebGL", "AudioAPI", "JavaScript"],
    githubUrl: "https://github.com/visal/synthwave-racer",
    views: 5200,
    likes: 412,
    featured: true,
...
function loadAppsData() {
  const saved = localStorage.getItem("nexus_web_apps_v2");
  if (saved) {
    try {
...
function saveAppsData() {
  localStorage.setItem("nexus_web_apps_v2", JSON.stringify(appsData));
}
